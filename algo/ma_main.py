...
from algo.matd3.matd3_agent import MATD3
...
def main(args):
    ...
    if args.algo == "matd3":
        model = MATD3(n_states, n_actions, n_agents, 2, args)
    ...
    while episode < args.max_episodes:
        ...
        while True:
            ...
            if args.mode == "train":
                ...
                if args.algo == "maddpg" or args.algo == "matd3":
                ...
                if args.episode_length < step or (True in done):
                    ...
                    print("[Episode %05d] reward %6.4f reward_1 %6.4f reward_2 %6.4f reward_3 %6.4f" % (episode, accum_reward, rewardA, rewardB, rewardC))
                    if args.tensorboard:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_episodes', default=1e5, type=int)
    parser.add_argument('--algo', default="maddpg", type=str, help="maddpg/matd3")
    ...
    parser.add_argument("--model_episode", default=20000, type=int)
